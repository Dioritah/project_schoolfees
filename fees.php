...
{
$errormsg = "<div class='alert alert-success'><a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a><strong>Succès!</strong> Les frais ont été soumis</div>";
}
...
function mydatatable()
{
              ...
              $("#subjectresult").html('<table class="table table-striped table-bordered table-hover" id="tSortable22"><thead><tr><th>Nom/Contact</th><th>Frais</th><th>Solde</th><th>Filière</th><th>Date adhésion</th><th>Action</th></tr></thead><tbody></tbody></table>');
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">Collecter les frais</h4>
        </div>
